      ...
      <div className="relative w-full max-w-xl rounded-xl overflow-hidden shadow-lg bg-white border border-gray-200">
        ...
        <div className="w-2/3 bg-white p-4">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-md font-bold text-[#1d1c1d]"># project-unicorn</h3>
          ...
          <div className="space-y-3">
            <div>
              <div className="flex items-center gap-2 font-bold text-sm text-[#1d1c1d]">
                <div className="w-6 h-6 rounded-full bg-yellow-300 flex items-center justify-center text-black text-xs">👩</div>
                Zoe Maxwell
              </div>
              <p className="text-sm text-gray-700 ml-8">Are we ready for launch?</p>
            </div>
  
            <div>
              <div className="flex items-center gap-2 font-bold text-sm text-[#1d1c1d]">
                <div className="w-6 h-6 rounded-full bg-blue-300 flex items-center justify-center text-black text-xs">🧔</div>
                Matt Brewer
              </div>
              <p className="text-sm text-gray-700 ml-8">Here's the run of show:</p>
              <div className="ml-8 mt-2 bg-gray-100 px-4 py-2 rounded-lg inline-block text-sm text-gray-500">
                🔒 Access details hidden
                <span className="ml-2 bg-white px-2 py-1 rounded-full shadow text-xs">⋯ 5</span>
              </div>
            </div>
          </div>
        </div>
